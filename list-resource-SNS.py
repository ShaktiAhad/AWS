...
def lambda_handler(event=None, context=None):
    ...
    def excel_file():
        workbook = xlsxwriter.Workbook(f'AWS_Resources_list_{today}.xlsx')
    ...
    def upload_file():
        ...
        s3_client.Bucket('ahad-test-3').upload_file(Filename=f'AWS_Resources_list_{today}.xlsx', Key=f'resources/AWS_Resources_list_{today}.xlsx')
